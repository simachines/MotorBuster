...
**MotorBuster** is a specialized FFB testing toolkit. It allows you to sequence haptic effects (vibrations, forces, textures) and play them back in real-time on any DirectInput compatible device (Gamepads, Steering Wheels, Flight Sticks).
